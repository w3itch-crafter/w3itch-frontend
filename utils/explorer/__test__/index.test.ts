...
describe('Get explorer link', () => {
  it('Ethereum', () => {
    const expected: ExpectedValue = {
      [ExplorerDataType.ADDRESS]:
        'https://etherscan.io/address/0x3dc0f71c448154ff8b2572ec812964ed2a58ed3a',
      ...
      [ExplorerDataType.TOKEN]:
        'https://etherscan.io/token/0x3f1b56c64c9fffde6e6e0e93b4149a9ef4362ebc',
    }
    const address = getExplorerLink(
      1,
      '0x3Dc0F71C448154Ff8B2572Ec812964eD2A58Ed3A',
      ExplorerDataType.ADDRESS
    )
    ...
    const token = getExplorerLink(
      1,
      '0x3F1b56C64c9FFFdE6e6e0e93B4149a9EF4362eBc',
      ExplorerDataType.TOKEN
    )
  ...
  it('Ethereum Rinkeby', () => {
    const expected: ExpectedValue = {
      [ExplorerDataType.ADDRESS]:
        'https://rinkeby.etherscan.io/address/0x580541722d4ff64328ff46a2cc3b3756c93cd11e',
      ...
      [ExplorerDataType.TOKEN]:
        'https://rinkeby.etherscan.io/token/0xa1016e7fc56be94d087dd7e4d9f8365a331cef45',
    }
    const address = getExplorerLink(
      4,
      '0x580541722d4fF64328FF46a2cC3b3756C93cd11E',
      ExplorerDataType.ADDRESS
    )
    ...
    const token = getExplorerLink(
      4,
      '0xA1016e7Fc56bE94d087DD7E4D9f8365a331CeF45',
      ExplorerDataType.TOKEN
    )
  ...
  it('Biance Mainnet', () => {
    const expected: ExpectedValue = {
      [ExplorerDataType.ADDRESS]:
        'https://bscscan.com/address/0xdc0187399f9913e12115649156faa71d2cc4953f',
      ...
      [ExplorerDataType.TOKEN]:
        'https://bscscan.com/token/0x2d18298d0e3f1a059cbe0ec50a8a2e6e582a1e7b',
    }
    const address = getExplorerLink(
      56,
      '0xDC0187399F9913E12115649156faA71D2Cc4953F',
      ExplorerDataType.ADDRESS
    )
    ...
    const token = getExplorerLink(
      56,
      '0x2D18298d0e3f1A059CBE0EC50a8A2E6e582A1e7B',
      ExplorerDataType.TOKEN
    )
