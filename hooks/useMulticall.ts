...
export const staticMulticallByChainId = (chainId: SupportedChainId): MulticallType =>
  Multicall__factory.connect(MULTICALL_NETWORKS[chainId], Providers[chainId] as Provider)
